...
function FullStackJobs() {
  ...
  // Filter jobs for FullStack positions
  const filteredJobs = allJobs.filter((job) => {
    ...
    const skillsToCheck = [
      ...
      "fullstack" // Including "fullstack" to match any title containing it
    ];

    return skillsToCheck.some(skill => jobTitle.includes(skill)) && matchesLocation && matchesExp;
  });
      ...
      <div className="md:mx-10 min-h-screen">
        ...
        <div className="flex gap-4 mt-8">
          <div className="p-2 bg-gray-50 md:mt-10 w-full md:w-3/4 flex flex-col gap-4">
            <div className="mb-4">
              <h1 className="text-2xl">FullStack Developer Jobs</h1>
