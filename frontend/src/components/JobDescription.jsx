    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Salary: <span className='pl-4 font-normal text-gray-800'>{singleJob?.salary}LPA - <span> <Badge className={'text-green-600 font-bold'} variant="ghost">Negotiable</Badge> </span> </span></h1>
