...
const LatestJobs = () => {
  ...
  return (
    <>
      ...
      <div className="mt-10 lg:mx-10 md:mb-20 px-4 md:mx-4">
        <label
          className="text-xl md:text-3xl font-medium mt-4 lg:ml-6"
          style={{ fontFamily: "Inter" }}
        >
          New Job Listing
        </label>
        <div
          className="flex justify-end md:mx-20 "
          onClick={() => navigate("/jobs")}
        >
          <label
            className="text-[#EE6C4D] text-xl lg:text-3xl font-semibold underline hidden md:block cursor-pointer"
            style={{ fontFamily: "Inter" }}
          >
            Explore all jobs
          </label>
        </div>
        <div className="grid grid-cols gap-4 py-6">
          {allJobs.length <= 0 ? (
              ...
              <div className="mt-4 space-y-6">
                {[
                  ...
                  >
                    ...
                    <label
                      className=" text-xs text-justify md:block"
                      style={{ fontFamily: "Inter" }}
                    >
                      {point}
                    </label>
