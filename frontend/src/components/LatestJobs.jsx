...
const LatestJobs = () => {
  ...
  return (
    <>
      <div className="mt-10 lg:mx-10 text-center md:mb-20">
      <label className="text-center text-xl lg:text-3xl font-semibold " style={{ fontFamily: 'Inter' }}>
          New Job Listing
        </label>
        <div className="flex justify-end md:mx-20 ">
        <label className="text-[#EE6C4D] text-xl lg:text-3xl font-semibold underline hidden md:block" style={{fontFamily:'Inter'}}>Explore all jobs</label>
        </div>
