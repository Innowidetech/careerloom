...
const LatestJobCards = ({ job }) => {
  ...
  const handleAddToWishlist = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://careerloom.onrender.com/api/v1/wishlist/add",
        {
          title: job.title,
  ...
  return (
    <div className="p-4 rounded-md shadow-sm bg-white border border-gray-200 flex flex-row justify-between items-center mb-4 md:mx-2 lg:mx-8">
